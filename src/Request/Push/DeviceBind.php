...
class DeviceBind extends PhpecsRequest
{
    private $api = 'push/v1/device/register';
    ...
    public function getResponse()
    {
        ...
        if (Valid::isDeviceType($this->deviceType) === false) {
            throw new PhpecsException('设备类型未设置或值无效');
        }
